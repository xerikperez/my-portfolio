        ...
        <Row>
          ...
          >
            ...
            <Container className="d-flex flex-column gap-5 mb-3 fs-5" style={{ maxWidth: "200px" }}>
              <Button as="a" href="https://github.com/xerikperez" target="_blank" rel="noopener noreferrer">
                GitHub
              </Button>
              <Button as="a" href="https://linkedin.com/in/erikpérez" target="_blank" rel="noopener noreferrer">
                LinkedIn
              </Button>
